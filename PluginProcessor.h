...
private:
    ...
    void noteChanger(int currentNote, juce::SortedSet<int> notes, int lastNoteValue, juce::MidiBuffer& midiMessages, int offset, int time, int numSamples, int noteDuration);
    //==============================================================================
